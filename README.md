...
### Features
- **Live Game Tracking** - Real-time status indicators for in-progress games
- **Smart Game Filtering** - Automatic distinction between completed, live, and scheduled games
...
└── data/
    └── NBA_Teams_List.txt # Team reference data
```
